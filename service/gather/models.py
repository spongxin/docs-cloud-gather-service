...
class Package(models.Model):
    ...
    date = models.DateField(null=True, blank=True, verbose_name="截止日期", help_text="选择<b>设置截止时间</b>后生效")
    time = models.TimeField(null=True, blank=True, verbose_name="截止时间", help_text="选择<b>设置截止时间</b>后生效")
    filesize = models.BooleanField(default=True, verbose_name="限制文件大小", help_text="限制单次提交文件的大小")
    size = models.IntegerField(default=64, verbose_name="最大文件大小", help_text="选择<b>限制文件大小</b>后生效")
