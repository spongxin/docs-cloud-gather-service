...
class Package(models.Model):
    ...
    description = models.CharField(max_length=100, null=True, blank=True, verbose_name="描述(选填)", help_text="文档收集仓库的描述")
    items = models.JSONField(null=True, blank=True, editable=False, verbose_name="用户填写信息")
    formats = models.CharField(max_length=50, null=True, blank=True, verbose_name="重命名格式", help_text="将根据该格式重命名已收集文件，用户填写的信息将替换对应标签")
    ...
    size = models.IntegerField(default=20, verbose_name="最大文件大小", help_text="选择`限制文件大小`后生效")
